 ...
 */
final class Version20200323212836 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, image LONGBLOB DEFAULT NULL, titre VARCHAR(255) NOT NULL, contenu VARCHAR(500) NOT NULL, date_parution DATETIME NOT NULL, publie TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
